...
const translations = {
  es: {
    ...
    nav: {
      ...
      medicalHistory: 'Historias Médicas',
  ...
  pt: {
    ...
    nav: {
      ...
      clinicalManagement: 'Gestão Clínica',
      medicalHistory: 'Históricos Médicos',
      appointments: 'Consultas',
      prescriptions: 'Prescrições',
      emergency: 'Emergência',
      labResults: 'Laboratório',
      alerts: 'Alertas',
  ...
  fr: {
    ...
    nav: {
      ...
      clinicalManagement: 'Gestion Clinique',
  ...
  qu: {
    ...
    nav: {
      ...
      clinicalManagement: 'Hampiq Kamachiy',
      medicalHistory: 'Unquy Willakuy',
      appointments: 'Tupanakuy',
      prescriptions: 'Hampikuna',
      emergency: 'Usqhay Yanapay',
      labResults: 'Laboratorio',
      alerts: 'Willakuykuna',
      consents: 'Ari Niy',
      referrals: 'Kachakuykuna',
      admin: 'Kamachiq',
      login: 'Yaykuy',
      logout: 'Lluqsiy',
      userMenu: 'Runakunaq menú',
    },
    home: {
