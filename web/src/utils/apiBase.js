...
const resolveBackendBase = () => {
  const raw =
    ...
    'https://searches-tribune-nottingham-landing.trycloudflare.com';
...
const resolveAiBase = () => {
  const raw = process.env.REACT_APP_AI_URL || 'https://searches-tribune-nottingham-landing.trycloudflare.com/ai';
