...
const resolveBackendBase = () => {
  const raw =
    ...
    'https://cities-described-convicted-settle.trycloudflare.com';
...
const resolveAiBase = () => {
  const raw = process.env.REACT_APP_AI_URL || 'https://cities-described-convicted-settle.trycloudflare.com/ai';
