...
const resolveBackendBase = () => {
  const raw =
    ...
    'https://depending-extremely-styles-material.trycloudflare.com';
...
const resolveAiBase = () => {
  const raw = process.env.REACT_APP_AI_URL || 'https://depending-extremely-styles-material.trycloudflare.com/ai';
